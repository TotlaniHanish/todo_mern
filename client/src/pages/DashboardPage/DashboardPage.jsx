        ...
        <div className="flex-1 bg-neutral-50">
            ...
            <div className="mx-auto min-h-[30rem] w-full max-w-7xl px-2 pb-8 pt-4 sm:px-4">
                <main className="w-full space-y-4">
                    {/* Hello section */}
                    <div className="overflow-hidden rounded-lg bg-gradient-to-l from-blue-200 via-white to-white shadow">
                    ...
                    <section className="bg-white px-4 py-5 shadow sm:p-6 lg:flex-row lg:space-y-2 lg:space-x-4">
                        <div className="flex w-full flex-col">
                            <div className="flex justify-between">
                                ...
                                <button
                                    className="h-8 w-32 rounded border border-transparent bg-blue-600 px-2 py-1 text-sm text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
