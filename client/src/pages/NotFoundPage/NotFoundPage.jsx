        ...
        <div className="mx-auto flex max-w-7xl flex-grow items-center justify-center sm:my-32">
            <div className="relative pl-4">
                ...
                <div className="mt-6 flex">
                    <Link
                        to="/"
                        className="flex items-center justify-center rounded-md border border-transparent bg-blue-600 py-2 px-5 text-base font-medium text-white hover:bg-blue-700"
                    >
                        Go back home
                    </Link>
                </div>
