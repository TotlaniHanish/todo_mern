                    ...
                    <ul className="flex items-center gap-4" >
                        {user ? (
                            <li key="Logout">
                                ...
                                >
                                    <div title="LogOut" className="text-2xl">
                                    <SlLogout />
                                    </div>
                            ...
                            <>
                                ...
                                <Link
                                    to="/signup"
                                    className="inline-flex items-center rounded-md bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-1.5 text-center text-base font-medium text-white hover:bg-gradient-to-l"
                                >
                                    Sign up
                                </Link>
                            </>
                ...
                <ul>
                    ...
                    {user ? (
                        <li key="Logout">
                            ...
                            >
                                <span className="relative" title="Logout">
                                    Logout
                                    <div className="absolute bottom-0 h-0.5 w-full scale-0 bg-white transition duration-[200ms] ease-in-out group-hover:scale-100" />
                                </span>
                            </button>
